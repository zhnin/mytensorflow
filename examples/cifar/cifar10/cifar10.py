...
tf.app.flags.DEFINE_string('data_dir', 'D:\\softfiles\\workspace\\data\\tensorflow\\data\\cifar10',
                           """data_dir""")
tf.app.flags.DEFINE_boolean('use_fp16', False, """using fp16""")
...
def inference(image):
    ...
    pool2 = tf.nn.max_pool(norm2, ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1], padding='SAME', name='pool1')
...
def train(loss, global_step):
    ...
    loss_average_op = _add_loss_summaries(loss)
...
def distorted_inputs():
    ...
    images, labels = cifar10_input.distorted_inputs(data_dir, FLAGS.batch_size)
